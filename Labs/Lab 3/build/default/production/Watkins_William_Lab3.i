# 1 "Watkins_William_Lab3.asm"
# 1 "<built-in>" 1
# 1 "Watkins_William_Lab3.asm" 2
...
# 154 "Watkins_William_Lab3.asm" 2
...
Initial:
    ...
    BSF LATD, 0x5, A ; Turn ON ((PORTD) and 0FFh), 5, a
    RCALL Wait1secInit ; call subroutine to wait 1 second
    BCF LATD, 0x5, A ; Turn OFF ((PORTD) and 0FFh), 5, a
    BSF LATD, 0x6, A ; Turn ON ((PORTD) and 0FFh), 6, a
    RCALL Wait1secInit ; call subroutine to wait 1 second
    BCF LATD, 0x6, A ; Turn OFF ((PORTD) and 0FFh), 6, a
    BSF LATD, 0x7, A ; Turn ON ((PORTD) and 0FFh), 7, a
    RCALL Wait1secInit ; call subroutine to wait 1 second
    BCF LATD, 0x7, A ; Turn OFF ((PORTD) and 0FFh), 7, a
