...
SOURCEFILES_QUOTED_IF_SPACED=lab2_watkins.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lab2_watkins.o
POSSIBLE_DEPFILES=${OBJECTDIR}/lab2_watkins.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lab2_watkins.o

# Source Files
SOURCEFILES=lab2_watkins.asm
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lab2_watkins.o: lab2_watkins.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab2_watkins.o 
	${MP_AS} -mcpu=PIC18F87K22 -c \
	-o ${OBJECTDIR}/lab2_watkins.o \
	lab2_watkins.asm \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Lab_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
