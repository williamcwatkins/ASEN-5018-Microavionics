# 1 "../Watkins William Lab6 Part 1 - Code.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Watkins William Lab6 Part 1 - Code.c" 2
# 126 "../Watkins William Lab6 Part 1 - Code.c"
...
# 126 "../Watkins William Lab6 Part 1 - Code.c" 2
...
# 127 "../Watkins William Lab6 Part 1 - Code.c" 2
...
# 128 "../Watkins William Lab6 Part 1 - Code.c" 2
...
# 129 "../Watkins William Lab6 Part 1 - Code.c" 2
...
unsigned short DACTemp = 0b0010000000000000;
char trashSPI = 0;
char DTIMEDACL = 0;
char DTIMEDACH = 0;
# 231 "../Watkins William Lab6 Part 1 - Code.c"
void Initial(void);
void handleADC(void);
void readADC(void);
...
# 285 "../Watkins William Lab6 Part 1 - Code.c"
void Initial() {
    ...
    T3CON = 0b00000010;
# 341 "../Watkins William Lab6 Part 1 - Code.c"
    DTIMEONL = timeON & 0xFF;
    DTIMEONH = timeON>>8 & 0xFF;
...
# 461 "../Watkins William Lab6 Part 1 - Code.c"
void handleADC() {
    readADC();
...
# 523 "../Watkins William Lab6 Part 1 - Code.c"
void readADC() {
...
# 546 "../Watkins William Lab6 Part 1 - Code.c"
void displayLCD() {
    DisplayC(row1LCD);
    DisplayC(row2LCD);
}
# 564 "../Watkins William Lab6 Part 1 - Code.c"
...
# 591 "../Watkins William Lab6 Part 1 - Code.c"
...
# 642 "../Watkins William Lab6 Part 1 - Code.c"
void CCP1Handler() {
    ...
    DACTemp = (CCPR1H<<8) | CCPR1L;
    DACTemp = DACTemp + DACInterval;
    CCPR1H = DACTemp>>8 & 0xFF;
    CCPR1L = DACTemp & 0xFF;

    PIR3bits.CCP1IF = 0;
}
# 667 "../Watkins William Lab6 Part 1 - Code.c"
void CCP3Handler() {
...
# 689 "../Watkins William Lab6 Part 1 - Code.c"
void TMR0Handler() {
    T0CONbits.TMR0ON = 0;
    TMR0H = 0x0B;
    TMR0L = 0xDC;
...
# 716 "../Watkins William Lab6 Part 1 - Code.c"
void TMR1Handler() {

    PIR1bits.TMR1IF = 0;
}
# 729 "../Watkins William Lab6 Part 1 - Code.c"
void TMR3Handler() {
    TMR3X++;
    PIR2bits.TMR3IF = 0;
}
# 742 "../Watkins William Lab6 Part 1 - Code.c"
...
# 774 "../Watkins William Lab6 Part 1 - Code.c"
void aliveLED() {
    if(LATDbits.LATD4 == 1)
    {
        LATDbits.LATD4 = 0;
...
# 803 "../Watkins William Lab6 Part 1 - Code.c"
void readCommand() {
...
# 838 "../Watkins William Lab6 Part 1 - Code.c"
void sendContinuous() {
    TXREG1 = contSend[sendI];
    PIE1bits.TX1IE = 1;
    sendI++;
}
# 852 "../Watkins William Lab6 Part 1 - Code.c"
void sendTemperature() {
    TXREG1 = tempSend[sendI];
    PIE1bits.TX1IE = 1;
    sendI++;
}
# 866 "../Watkins William Lab6 Part 1 - Code.c"
void sendPotentiometer() {
    TXREG1 = potSend[sendI];
    PIE1bits.TX1IE = 1;
    sendI++;
}
# 880 "../Watkins William Lab6 Part 1 - Code.c"
void sendNext() {
...
# 921 "../Watkins William Lab6 Part 1 - Code.c"
void updateDAC() {
    LATE = 0;
