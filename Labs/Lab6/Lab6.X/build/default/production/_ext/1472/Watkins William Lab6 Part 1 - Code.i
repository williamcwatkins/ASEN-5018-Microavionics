...
# 124 "../Watkins William Lab6 Part 1 - Code.c"
...
# 124 "../Watkins William Lab6 Part 1 - Code.c" 2
...
# 125 "../Watkins William Lab6 Part 1 - Code.c" 2
...
unsigned short DACTemp = 0b0011000000000000;
char trashSPI = 0;
char DTIMEDACL = 0;
char DTIMEDACH = 0;
# 229 "../Watkins William Lab6 Part 1 - Code.c"
void Initial(void);
void handleADC(void);
void readADC(void);
...
void main() {
    Initial();
    while(1) {
# 270 "../Watkins William Lab6 Part 1 - Code.c"
        if(DACUpdate == 1)
            updateDAC();

     }
}
# 284 "../Watkins William Lab6 Part 1 - Code.c"
void Initial() {
    ...
    INTCONbits.TMR0IE = 1;
    INTCONbits.TMR0IF = 0;
# 421 "../Watkins William Lab6 Part 1 - Code.c"
    LATD = 0b00100000;
    T0CONbits.TMR0ON = 1;
    while(LED_count < 4) {}
...
# 459 "../Watkins William Lab6 Part 1 - Code.c"
void handleADC() {
    readADC();
...
# 521 "../Watkins William Lab6 Part 1 - Code.c"
void readADC() {
...
# 544 "../Watkins William Lab6 Part 1 - Code.c"
void displayLCD() {
    DisplayC(row1LCD);
    DisplayC(row2LCD);
}
# 562 "../Watkins William Lab6 Part 1 - Code.c"
...
# 589 "../Watkins William Lab6 Part 1 - Code.c"
...
# 640 "../Watkins William Lab6 Part 1 - Code.c"
void CCP1Handler() {
...
# 665 "../Watkins William Lab6 Part 1 - Code.c"
void CCP3Handler() {
...
# 687 "../Watkins William Lab6 Part 1 - Code.c"
void TMR0Handler() {
    T0CONbits.TMR0ON = 0;
    TMR0H = 0x0B;
    TMR0L = 0xDC;
...
# 714 "../Watkins William Lab6 Part 1 - Code.c"
void TMR1Handler() {

    PIR1bits.TMR1IF = 0;
}
# 727 "../Watkins William Lab6 Part 1 - Code.c"
void TMR3Handler() {
    TMR3X++;
    PIR2bits.TMR3IF = 0;
}
# 740 "../Watkins William Lab6 Part 1 - Code.c"
...
# 772 "../Watkins William Lab6 Part 1 - Code.c"
void aliveLED() {
    if(LATDbits.LATD4)
        {
            LATDbits.LATD4 = 0;
...
# 805 "../Watkins William Lab6 Part 1 - Code.c"
void readCommand() {
...
# 840 "../Watkins William Lab6 Part 1 - Code.c"
void sendContinuous() {
    PIE1bits.TX1IE = 1;
    TXREG1 = contSend[sendI];
    sendI++;
}
# 854 "../Watkins William Lab6 Part 1 - Code.c"
void sendTemperature() {
    PIE1bits.TX1IE = 1;
    TXREG1 = tempSend[sendI];
    sendI++;
}
# 868 "../Watkins William Lab6 Part 1 - Code.c"
void sendPotentiometer() {
    PIE1bits.TX1IE = 1;
    TXREG1 = potSend[sendI];
    sendI++;
}
# 882 "../Watkins William Lab6 Part 1 - Code.c"
void sendNext() {
...
# 928 "../Watkins William Lab6 Part 1 - Code.c"
void updateDAC() {
