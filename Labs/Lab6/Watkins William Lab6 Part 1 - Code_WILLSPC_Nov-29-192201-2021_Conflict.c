...
//  NEXT TODO IS TESTING JUST THE ALIVE LED TEST
...
// Flags
char DACUpdate = 0; // flag to indicate DAC must be updated
...
unsigned short DACTemp = 0b0010000000000000; // 16 bits to shift into SSPBUF
